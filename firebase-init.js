...
// Tracker (Ledger) data lives in its own namespaced collections/doc so it
// never mixes with the portfolio's "projects" / "site" collections.
export const TRACKER_PROJECTS_COLLECTION = "tracker_projects";
export const TRACKER_INVOICES_COLLECTION = "tracker_invoices";
export const TRACKER_SETTINGS_DOC = ["tracker_meta", "settings"]; // db doc(...TRACKER_SETTINGS_DOC)
